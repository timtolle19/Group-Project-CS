...
""",
    ...
    # Layout for navigation buttons: previous on the far left (wider),
    # next/complete on the far right
    ...
    with col_prev:
        if not is_first:
            # Use non-breaking space so "Previous Exercise" stays on one line
